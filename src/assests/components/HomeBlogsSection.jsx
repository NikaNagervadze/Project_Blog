...
function HomeBlogsSection() {
  ...
  return (
    ...
    <section className="blogs-section container-fluid" style={{ height: containerHeight + 150 }}>
      ...
      <div className='blogs-footer d-grid justify-content-center '>
        <h2>Final Blog Project</h2>
        <p>This Final Blog Project Was Made By Nick Nagervadze</p>
        <a href="https://www.instagram.com/nika.nagerwadzenn/"><img src={Instagram} alt="My Image"/>Instagram</a>
        <a href="https://www.facebook.com/profile.php?id=100087056904921"><img src={Facebook} alt="My Image"/>Facebook</a>
      </div>
